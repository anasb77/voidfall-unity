...
// ───────────────────────────────────────────────────────────────────
import type { ArenaId, PassiveId, WeaponId } from "./types";
...
function freshSave(): SaveData {
  return {
    ...
    totalDamageDealt: 0,
    totalDamageTaken: 0,
    favChar: { sentinel: 0, phantom: 0, bastion: 0, overseer: 0, wraith: 0, elemental: 0, chronomancer: 0, necromancer: 0, missile: 0, spider: 0, tank: 0 },
    favWeapon: { pistol: 0, shotgun: 0, smg: 0, railgun: 0, arc: 0, flame: 0, rocket: 0, blades: 0, drone: 0, mines: 0, ice: 0, nova: 0, crossbow: 0, tendrils: 0, plasma: 0, thunder: 0, chain: 0, voidorb: 0 },
