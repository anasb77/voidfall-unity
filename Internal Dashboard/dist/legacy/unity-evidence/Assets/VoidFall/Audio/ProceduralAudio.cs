...
namespace VoidFall.Runtime
{
    ...
    public sealed class ProceduralAudio : MonoBehaviour
    {
        ...
        // Owner-locked sound-lab raid alternates (2026-09-21/22): War Horn
        // Triple, Husk Drone and Spite Shriek, each baked as a triple-hit
        // like the lab's x3 stack.
        private readonly AudioClip[] _raidNoticeClips = new AudioClip[3];
        private int _raidNoticeIndex;
        // Owner-locked arrival set (2026-09-22): the same incident voices baked
        // as five stacked hits. Played once when Warning becomes Active.
        private readonly AudioClip[] _raidArrivalClips = new AudioClip[3];
        private int _raidArrivalIndex;
        ...
        private AudioClip ResolveRoundRobin(Cue cue)
        {
            switch (cue)
            {
                ...
                case Cue.RaidNotice: return NextRoundRobin(_raidNoticeClips, ref _raidNoticeIndex);
                case Cue.RaidArrival: return NextRoundRobin(_raidArrivalClips, ref _raidArrivalIndex);
                default: return null;
            }
        }
        ...
        private static float GateSeconds(Cue cue)
        {
            switch (cue)
            {
                ...
                case Cue.SeekerBlast: return 0.120f;
        ...
        {
            // Owner-locked sound-lab set (2026-09-21/22), each incident baked as a
            // triple-hit like the lab's x3 stack (echoes at +0.09s x0.85 and
            // +0.18s x0.70). Raid alternates three variants via round-robin;
            // _clips[RaidNotice] keeps pointing at variant A so the cached-cue
            // contract in NotificationPresentationTests still holds.
            _raidNoticeClips[0] = BuildSequence("vf_raid_warhorn_x3", 1.28f, new[] {
                new SequenceNote(147f, 147f, 0.22f, 0f, 0.11f, Waveform.Square),
                new SequenceNote(147f, 147f, 0.22f, 0.26f, 0.11f, Waveform.Square),
                new SequenceNote(147f, 147f, 0.3f, 0.52f, 0.11f, Waveform.Square),
                new SequenceNote(98f, 98f, 1f, 0f, 0.12f, Waveform.Sine),
                new SequenceNote(147f, 147f, 0.22f, 0.09f, 0.0935f, Waveform.Square),
                new SequenceNote(147f, 147f, 0.22f, 0.35f, 0.0935f, Waveform.Square),
                new SequenceNote(147f, 147f, 0.3f, 0.61f, 0.0935f, Waveform.Square),
                new SequenceNote(98f, 98f, 1f, 0.09f, 0.102f, Waveform.Sine),
                new SequenceNote(147f, 147f, 0.22f, 0.18f, 0.077f, Waveform.Square),
                new SequenceNote(147f, 147f, 0.22f, 0.44f, 0.077f, Waveform.Square),
                new SequenceNote(147f, 147f, 0.3f, 0.7f, 0.077f, Waveform.Square),
                new SequenceNote(98f, 98f, 1f, 0.18f, 0.084f, Waveform.Sine) });
            _raidNoticeClips[1] = BuildSequence("vf_raid_huskdrone_x3", 1.48f, new[] {
                new SequenceNote(110f, 110f, 1.1f, 0f, 0.11f, Waveform.Saw),
                new SequenceNote(117f, 117f, 1.1f, 0f, 0.11f, Waveform.Saw),
                new SequenceNote(55f, 55f, 1.2f, 0f, 0.13f, Waveform.Sine),
                new SequenceNote(110f, 110f, 1.1f, 0.09f, 0.0935f, Waveform.Saw),
                new SequenceNote(117f, 117f, 1.1f, 0.09f, 0.0935f, Waveform.Saw),
                new SequenceNote(55f, 55f, 1.2f, 0.09f, 0.1105f, Waveform.Sine),
                new SequenceNote(110f, 110f, 1.1f, 0.18f, 0.077f, Waveform.Saw),
                new SequenceNote(117f, 117f, 1.1f, 0.18f, 0.077f, Waveform.Saw),
                new SequenceNote(55f, 55f, 1.2f, 0.18f, 0.091f, Waveform.Sine) });
            // Sound-lab raid-03 "Spite Shriek" (2026-09-22): high detuned scream
            // over low drone, likewise baked as a triple-hit.
            _raidNoticeClips[2] = BuildSequence("vf_raid_spiteshriek_x3", 1.13f, new[] {
                new SequenceNote(55f, 55f, 0.9f, 0f, 0.13f, Waveform.Sine),
                new SequenceNote(880f, 660f, 0.35f, 0.08f, 0.06f, Waveform.Saw),
                new SequenceNote(932f, 700f, 0.35f, 0.08f, 0.06f, Waveform.Saw),
                new SequenceNote(55f, 55f, 0.9f, 0.09f, 0.1105f, Waveform.Sine),
                new SequenceNote(880f, 660f, 0.35f, 0.17f, 0.051f, Waveform.Saw),
                new SequenceNote(932f, 700f, 0.35f, 0.17f, 0.051f, Waveform.Saw),
                new SequenceNote(55f, 55f, 0.9f, 0.18f, 0.091f, Waveform.Sine),
                new SequenceNote(880f, 660f, 0.35f, 0.26f, 0.042f, Waveform.Saw),
                new SequenceNote(932f, 700f, 0.35f, 0.26f, 0.042f, Waveform.Saw) },
                new[]
                {
                    new SequenceNoise(3000f, 0.4f, 0.04f, 0.1f, 1.5f),
                    new SequenceNoise(3000f, 0.4f, 0.034f, 0.19f, 1.5f),
                    new SequenceNoise(3000f, 0.4f, 0.028f, 0.28f, 1.5f),
                });
            _clips[(int)Cue.RaidNotice] = _raidNoticeClips[0];
            _clips[(int)Cue.EclipseNotice] = BuildSequence("vf_eclipse_shutterfall_x3", 1.18f, new[] {
                new SequenceNote(523f, 523f, 0.16f, 0f, 0.08f, Waveform.Square),
                new SequenceNote(440f, 440f, 0.16f, 0.17f, 0.08f, Waveform.Square),
                new SequenceNote(349f, 349f, 0.2f, 0.34f, 0.08f, Waveform.Square),
                new SequenceNote(196f, 98f, 0.5f, 0.4f, 0.1f, Waveform.Sine),
                new SequenceNote(523f, 523f, 0.16f, 0.09f, 0.068f, Waveform.Square),
                new SequenceNote(440f, 440f, 0.16f, 0.26f, 0.068f, Waveform.Square),
                new SequenceNote(349f, 349f, 0.2f, 0.43f, 0.068f, Waveform.Square),
                new SequenceNote(196f, 98f, 0.5f, 0.49f, 0.085f, Waveform.Sine),
                new SequenceNote(523f, 523f, 0.16f, 0.18f, 0.056f, Waveform.Square),
                new SequenceNote(440f, 440f, 0.16f, 0.35f, 0.056f, Waveform.Square),
                new SequenceNote(349f, 349f, 0.2f, 0.52f, 0.056f, Waveform.Square),
                new SequenceNote(196f, 98f, 0.5f, 0.58f, 0.07f, Waveform.Sine) });
            // Owner decision (2026-09-22): black hole keeps its current riser,
            // baked as a triple-hit like the lab's x3 stack.
            _clips[(int)Cue.BlackHoleNotice] = BuildSequence("vf_black_hole_notice_x3", 0.98f, new[] {
                new SequenceNote(82f, 330f, 0.65f, 0f, 0.12f, Waveform.Sine),
                new SequenceNote(660f, 110f, 0.45f, 0.2f, 0.07f, Waveform.Triangle),
                new SequenceNote(82f, 330f, 0.65f, 0.09f, 0.102f, Waveform.Sine),
                new SequenceNote(660f, 110f, 0.45f, 0.29f, 0.0595f, Waveform.Triangle),
                new SequenceNote(82f, 330f, 0.65f, 0.18f, 0.084f, Waveform.Sine),
                new SequenceNote(660f, 110f, 0.45f, 0.38f, 0.049f, Waveform.Triangle) });
            // Arrival set (2026-09-22): the locked incident voices baked as five
            // stacked hits (echoes at +0.09s x0.85, +0.18s x0.70, +0.27s x0.55,
            // +0.36s x0.42). _clips[RaidArrival] keeps pointing at variant A so
            // the cached-cue contract holds for arrival cues too.
            _raidArrivalClips[0] = BuildSequence("vf_raid_warhorn_x5", 1.46f, new[] {
                new SequenceNote(147f, 147f, 0.22f, 0f, 0.11f, Waveform.Square),
                new SequenceNote(147f, 147f, 0.22f, 0.26f, 0.11f, Waveform.Square),
                new SequenceNote(147f, 147f, 0.3f, 0.52f, 0.11f, Waveform.Square),
                new SequenceNote(98f, 98f, 1f, 0f, 0.12f, Waveform.Sine),
                ...
                new SequenceNote(147f, 147f, 0.3f, 0.7f, 0.077f, Waveform.Square),
                new SequenceNote(98f, 98f, 1f, 0.18f, 0.084f, Waveform.Sine),
                new SequenceNote(147f, 147f, 0.22f, 0.27f, 0.0605f, Waveform.Square),
                new SequenceNote(147f, 147f, 0.22f, 0.53f, 0.0605f, Waveform.Square),
                new SequenceNote(147f, 147f, 0.3f, 0.79f, 0.0605f, Waveform.Square),
                new SequenceNote(98f, 98f, 1f, 0.27f, 0.066f, Waveform.Sine),
                new SequenceNote(147f, 147f, 0.22f, 0.36f, 0.0462f, Waveform.Square),
                new SequenceNote(147f, 147f, 0.22f, 0.62f, 0.0462f, Waveform.Square),
                new SequenceNote(147f, 147f, 0.3f, 0.88f, 0.0462f, Waveform.Square),
                new SequenceNote(98f, 98f, 1f, 0.36f, 0.0504f, Waveform.Sine) });
            _raidArrivalClips[1] = BuildSequence("vf_raid_huskdrone_x5", 1.66f, new[] {
                new SequenceNote(110f, 110f, 1.1f, 0f, 0.11f, Waveform.Saw),
                new SequenceNote(117f, 117f, 1.1f, 0f, 0.11f, Waveform.Saw),
                new SequenceNote(55f, 55f, 1.2f, 0f, 0.13f, Waveform.Sine),
                new SequenceNote(110f, 110f, 1.1f, 0.09f, 0.0935f, Waveform.Saw),
                ...
                new SequenceNote(117f, 117f, 1.1f, 0.18f, 0.077f, Waveform.Saw),
                new SequenceNote(55f, 55f, 1.2f, 0.18f, 0.091f, Waveform.Sine),
                new SequenceNote(110f, 110f, 1.1f, 0.27f, 0.0605f, Waveform.Saw),
                new SequenceNote(117f, 117f, 1.1f, 0.27f, 0.0605f, Waveform.Saw),
                new SequenceNote(55f, 55f, 1.2f, 0.27f, 0.0715f, Waveform.Sine),
                new SequenceNote(110f, 110f, 1.1f, 0.36f, 0.0462f, Waveform.Saw),
                new SequenceNote(117f, 117f, 1.1f, 0.36f, 0.0462f, Waveform.Saw),
                new SequenceNote(55f, 55f, 1.2f, 0.36f, 0.0546f, Waveform.Sine) });
            _raidArrivalClips[2] = BuildSequence("vf_raid_spiteshriek_x5", 1.31f, new[] {
                new SequenceNote(55f, 55f, 0.9f, 0f, 0.13f, Waveform.Sine),
                new SequenceNote(880f, 660f, 0.35f, 0.08f, 0.06f, Waveform.Saw),
                new SequenceNote(932f, 700f, 0.35f, 0.08f, 0.06f, Waveform.Saw),
                new SequenceNote(55f, 55f, 0.9f, 0.09f, 0.1105f, Waveform.Sine),
                ...
                new SequenceNote(880f, 660f, 0.35f, 0.26f, 0.042f, Waveform.Saw),
                new SequenceNote(932f, 700f, 0.35f, 0.26f, 0.042f, Waveform.Saw),
                new SequenceNote(55f, 55f, 0.9f, 0.27f, 0.0715f, Waveform.Sine),
                new SequenceNote(880f, 660f, 0.35f, 0.35f, 0.033f, Waveform.Saw),
                new SequenceNote(932f, 700f, 0.35f, 0.35f, 0.033f, Waveform.Saw),
                new SequenceNote(55f, 55f, 0.9f, 0.36f, 0.0546f, Waveform.Sine),
                new SequenceNote(880f, 660f, 0.35f, 0.44f, 0.0252f, Waveform.Saw),
                new SequenceNote(932f, 700f, 0.35f, 0.44f, 0.0252f, Waveform.Saw) },
                new[]
                {
                    new SequenceNoise(3000f, 0.4f, 0.04f, 0.1f, 1.5f),
                    new SequenceNoise(3000f, 0.4f, 0.034f, 0.19f, 1.5f),
                    new SequenceNoise(3000f, 0.4f, 0.028f, 0.28f, 1.5f),
                    new SequenceNoise(3000f, 0.4f, 0.022f, 0.37f, 1.5f),
                    new SequenceNoise(3000f, 0.4f, 0.0168f, 0.46f, 1.5f),
                });
            _clips[(int)Cue.RaidArrival] = _raidArrivalClips[0];
            _clips[(int)Cue.EclipseArrival] = BuildSequence("vf_eclipse_shutterfall_x5", 1.36f, new[] {
                new SequenceNote(523f, 523f, 0.16f, 0f, 0.08f, Waveform.Square),
                new SequenceNote(440f, 440f, 0.16f, 0.17f, 0.08f, Waveform.Square),
                new SequenceNote(349f, 349f, 0.2f, 0.34f, 0.08f, Waveform.Square),
                new SequenceNote(196f, 98f, 0.5f, 0.4f, 0.1f, Waveform.Sine),
                ...
                new SequenceNote(349f, 349f, 0.2f, 0.52f, 0.056f, Waveform.Square),
                new SequenceNote(196f, 98f, 0.5f, 0.58f, 0.07f, Waveform.Sine),
                new SequenceNote(523f, 523f, 0.16f, 0.27f, 0.044f, Waveform.Square),
                new SequenceNote(440f, 440f, 0.16f, 0.44f, 0.044f, Waveform.Square),
                new SequenceNote(349f, 349f, 0.2f, 0.61f, 0.044f, Waveform.Square),
                new SequenceNote(196f, 98f, 0.5f, 0.67f, 0.055f, Waveform.Sine),
                new SequenceNote(523f, 523f, 0.16f, 0.36f, 0.0336f, Waveform.Square),
                new SequenceNote(440f, 440f, 0.16f, 0.53f, 0.0336f, Waveform.Square),
                new SequenceNote(349f, 349f, 0.2f, 0.7f, 0.0336f, Waveform.Square),
                new SequenceNote(196f, 98f, 0.5f, 0.76f, 0.042f, Waveform.Sine) });
            _clips[(int)Cue.BlackHoleArrival] = BuildSequence("vf_black_hole_notice_x5", 1.16f, new[] {
                new SequenceNote(82f, 330f, 0.65f, 0f, 0.12f, Waveform.Sine),
                new SequenceNote(660f, 110f, 0.45f, 0.2f, 0.07f, Waveform.Triangle),
                new SequenceNote(82f, 330f, 0.65f, 0.09f, 0.102f, Waveform.Sine),
                new SequenceNote(660f, 110f, 0.45f, 0.29f, 0.0595f, Waveform.Triangle),
                new SequenceNote(82f, 330f, 0.65f, 0.18f, 0.084f, Waveform.Sine),
                new SequenceNote(660f, 110f, 0.45f, 0.38f, 0.049f, Waveform.Triangle),
                new SequenceNote(82f, 330f, 0.65f, 0.27f, 0.066f, Waveform.Sine),
                new SequenceNote(660f, 110f, 0.45f, 0.47f, 0.0385f, Waveform.Triangle),
                new SequenceNote(82f, 330f, 0.65f, 0.36f, 0.0504f, Waveform.Sine),
                new SequenceNote(660f, 110f, 0.45f, 0.56f, 0.0294f, Waveform.Triangle) });
            ...
            // Owner-locked sound-lab rail-04 "Siege Driver" (2026-09-22):
            // sub slam first, slower tail. Single hit, not stacked.
            _clips[(int)Cue.Railgun] = BuildSequence(
                "vf_railgun_siegedriver",
                0.44f,
                new[]
                {
                    new SequenceNote(640f, 180f, 0.08f, 0f, 0.06f, Waveform.Square),
                    new SequenceNote(80f, 28f, 0.4f, 0.02f, 0.16f, Waveform.Saw),
                },
                new[] { new SequenceNoise(300f, 0.3f, 0.12f, 0.01f, 0.8f) });
            // Owner-locked sound-lab scatter-05 "Breach Slug" (2026-09-22):
            // heavy central-slug thump over tight crack. Single hit, not stacked.
            _clips[(int)Cue.Scattergun] = BuildSequence(
                "vf_scattergun_breachslug",
                0.34f,
                new[]
                {
                    new SequenceNote(140f, 50f, 0.24f, 0f, 0.13f, Waveform.Sine),
                    new SequenceNote(700f, 300f, 0.08f, 0.01f, 0.06f, Waveform.Square),
                },
                new[]
                {
                    new SequenceNoise(500f, 0.2f, 0.09f, 0f, 0.9f),
                    new SequenceNoise(2600f, 0.08f, 0.05f, 0.01f, 1.8f),
                });
            ...
            // Owner-locked sound-lab seeker-02 "Mortar Thump" (2026-09-22):
            // deep launch thump with airy follow. Single hit, not stacked.
            _clips[(int)Cue.Seeker] = BuildSequence(
                "vf_seeker_mortarthump",
                0.34f,
                new[]
                {
                    new SequenceNote(120f, 40f, 0.24f, 0f, 0.13f, Waveform.Sine),
                    new SequenceNote(400f, 900f, 0.12f, 0.04f, 0.045f, Waveform.Triangle),
                },
                new[] { new SequenceNoise(500f, 0.2f, 0.07f, 0f, 0.9f) });
            // Owner-locked sound-lab seeker-19 "Gravel Burn" (2026-09-22):
            // dirty low burn for rocket detonation. Played from the bullet
            // impact hooks in Sim.cs, not the fire path.
            _clips[(int)Cue.SeekerBlast] = BuildSequence(
                "vf_seeker_gravelburn",
                0.3f,
                new[] { new SequenceNote(240f, 110f, 0.2f, 0f, 0.08f, Waveform.Saw) },
                new[] { new SequenceNoise(520f, 0.22f, 0.08f, 0f, 0.8f) });
            ...
            // Owner-locked sound-lab rang-02 "Glaive Spin" (2026-09-21): audible
            // spin wobble from two detuned triangles; single hit, not stacked.
            _clips[(int)Cue.BoomerangThrow] = BuildSequence(
                "vf_boomerang_glaivespin",
                0.32f,
                new[]
                {
                    new SequenceNote(700f, 350f, 0.26f, 0f, 0.05f, Waveform.Triangle),
                    new SequenceNote(735f, 368f, 0.26f, 0f, 0.05f, Waveform.Triangle),
                },
                new[] { new SequenceNoise(1500f, 0.18f, 0.06f, 0.02f, 1.4f) });
