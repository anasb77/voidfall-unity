...
namespace VoidFall.Tests.PlayMode
{
    public sealed class ArsenalIntegrationTests
    {
        ...
        public void Roulette_new_card_cannot_bypass_weapon_slots()
        {
            ...
            progress.WeaponRanks[0] = progress.WeaponRanks[1] = progress.WeaponRanks[2] = progress.WeaponRanks[3] = 1;
            ...
            Assert.That(Array.FindAll(progress.WeaponRanks, rank => rank > 0).Length, Is.EqualTo(4));
        }
