...
(() => {
  ...
  window.NullCityArt={makeBackground,live,robot,path,line,rect,ellipse,circle,glow,text,glyph,rounded,tower,dome,habitat,forked,citadel,reactor,cityBlock,hangar,resetDecor(){ports.length=0;bands.length=0;holograms.length=0;}};
})();
